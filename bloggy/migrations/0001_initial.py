# Generated by Django 4.2.6 on 2023-11-03 00:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_created=True, auto_now_add=True, null=True)),
                ('updated_date', models.DateTimeField(auto_now=True, null=True)),
                ('meta_title', models.CharField(blank=True, help_text='Meta Title', max_length=120)),
                ('meta_description', models.TextField(blank=True, help_text='Meta Description')),
                ('meta_keywords', models.CharField(blank=True, help_text='Meta Keywords', max_length=300)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_type', models.CharField(choices=[['article', 'Article'], ['lesson', 'Lesson']], help_text='Select content type', max_length=20, verbose_name='Content type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_type', models.CharField(blank=True, choices=[['article', 'Article'], ['lesson', 'Lesson']], default='article', help_text='Post type', max_length=20, null=True, verbose_name='Post type')),
