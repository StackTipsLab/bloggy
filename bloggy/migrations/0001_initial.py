# Generated by Django 4.2.6 on 2023-11-01 09:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_type', models.CharField(choices=[['article', 'Article'], ['quiz', 'Quiz'], ['lesson', 'Lesson']], help_text='Select content type', max_length=20, verbose_name='Content type')),
                ('updated_date', models.DateTimeField(auto_now=True, null=True)),
