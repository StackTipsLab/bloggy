...
from bloggy_api.views.post_api import QuizzesAPIView, QuizDetailsAPIView
from bloggy_api.views.save_user_score import SaveUserScore
...
urlpatterns = [
    ...
    path('quizzes/save/score', login_required(SaveUserScore.as_view()), name="save_user_score"),
